...
import { userDetailAction } from "../stateManegement/actions";
import { store } from "../stateManegement/store";
import { PROFILE_URL, FILE_UPLOAD_URL } from "../url";
  ...
  return (
    <div className={`userAvatar ${props.isV2 ? "version2" : ""}`}>
      ...
      <div className="contents">
        ...
        {!props.noStatus && <div className="subContent">{props.language}</div>}
      </div>
    </div>
  );
};
